...
start_date = {
    'fd_incidents' : datetime(2019, 3, 15),
    'pd_cfs': datetime(2019, 3, 15),
    'pd_col': datetime(2019, 3, 15),
    'ttcs': datetime(2019, 3, 15),
    'indicator_bacteria_tests': datetime(2019, 3, 15),
    'parking_meters': datetime(2019, 3, 15),
    'traffic_counts': datetime(2019, 3, 15),
    'read': datetime(2019, 3, 15),
    'dsd_approvals': datetime(2019, 3, 15),
    'dsd_code_enforcement': datetime(2019, 3, 15),
    'streets_sdif': datetime(2019, 3, 15),
    'streets_imcat': datetime(2019, 3, 15),
    'get_it_done': datetime(2019, 3, 15),
    'gid_potholes': datetime(2019, 3, 15),
    'gid_ava': datetime(2019, 3, 15),
    'special_events': datetime(2019, 3, 15),
    'waze': datetime(2019, 3, 15),
    'inventory': datetime(2019, 3, 15),
    'buffer_post_promo': datetime(2019, 3, 15),
    'sonar': datetime(2019, 3, 15),
    'gis_daily': datetime(2019, 3, 15),
    'gis_weekly': datetime(2019, 3, 15),
    'budget': datetime(2019, 3, 15),
    'campaign_fin': datetime(2019, 3, 15),
    'public_art': datetime(2019, 3, 15),
    'sire': datetime(2019, 3, 15),
    'onbase': datetime(2019, 3, 15),
    'documentum_24' : datetime(2019, 3, 15),
    'documentum_others' : datetime(2019, 3, 15),
    'tsw_integration': datetime(2019, 3, 15),
    'cip': datetime(2019, 3, 15)
}
