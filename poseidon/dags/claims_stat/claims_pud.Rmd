...
#claims <- read.csv("http://seshat.datasd.org/risk/claims_clean_datasd_pud.csv", header=T, na.strings=c(""," ","NA"))
claims <-read.csv("http://datasd.dev.s3.amazonaws.com/risk/claims_clean_datasd_pud.csv") #change me for production URL
#claims<- read.csv("claimstat_raw.csv")
#claims<-subset(claims, ORG_CODE_SUBSTR=="2000")
...
Outputs
-----------------------------------------------------------------------
### PUD claims by location {data-width=350}
...
top_5_count<-subset(top_5_count, Fiscal_Year<2021) 
...
top_5_usd<-subset(top_5_usd, Fiscal_Year<2021) 
