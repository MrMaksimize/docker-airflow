...
output: 
  flexdashboard::flex_dashboard:
    orientation: rows
    navbar:
      - { title: "Tool Dictionary", href: "https://docs.google.com/spreadsheets/d/1GLVlV_zh2T-GayA83EWmTcC1wZTo2XhDsJl1QUIIS48/edit?usp=sharing", align: left }
...
claims <- read.csv("TSW_test.csv", header=T, na.strings=c(""," ","NA"))
