...
from poseidon.operators.poseidon_sonar_operator import PoseidonSonarCreator
...
#: Dag spec
dag = DAG(dag_id='streets_sdif', default_args=args, schedule_interval=schedule)
...
upload_streets_data = S3FileTransferOperator(
    ...
    source_key='sd_paving_datasd.csv',
    dest_s3_conn_id=conf['default_s3_conn_id'],
    dest_s3_bucket=conf['dest_s3_bucket'],
    dest_s3_key='tsw/sd_paving_datasd.csv',
    on_failure_callback=notify,
    on_retry_callback=notify,
    on_success_callback=notify,
    replace=True,
