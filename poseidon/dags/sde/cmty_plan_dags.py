"""_dags file for 'community plan' sde extraction."""
from airflow.models import DAG
from poseidon.util import general
from poseidon.dags.sde.cmty_plan_jobs import sde_to_shp
...
folder = 'cmty_plan'
layer = 'cmty_plan'
datasd_name = 'cmty_plan_datasd'
md = 'community-planning-district-boundaries'
