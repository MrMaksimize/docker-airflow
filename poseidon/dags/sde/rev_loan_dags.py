"""_dags file for 'revolving loan' sde extraction."""
from airflow.models import DAG
from poseidon.util import general
from poseidon.dags.sde.rev_loan_jobs import sde_to_shp
...
folder = 'sd_revloan'
layer = 'rev_loan'
datasd_name = 'rev_loan_datasd'
md = 'revolving-loan-fund-coverage'
